...
if __name__ == "__main__":
    ...
    parser.add_argument('--tracker_name', default="bttrack", type=str, help='Name of tracking method.')
    parser.add_argument('--cfg_name', default="", type=str, help='Name of config file.')
