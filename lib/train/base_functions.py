...
def get_optimizer_scheduler(net, cfg):
    ...
    if train_cls:
        ...
        param_dicts = [
            ...
            {"params": [p for n, p in net.named_parameters() if "backbone" in n and ("cls_token" in n) and p.requires_grad],
             "lr": cfg.TRAIN.LR * cfg.TRAIN.BACKBONE_MULTIPLIER * 5.,
             },
            {
                "params": [p for n, p in net.named_parameters() if "backbone" in n and p.requires_grad and ('cls_token' not in n)],
