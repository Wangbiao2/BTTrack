...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='bttrack', help='training script name')
...
def main():
    args = parse_args()
    if args.mode == "single":
        # Update the path to your own run_training.py
        train_cmd = "/home/buaa/TransformerTrackers/BTTrack/lib/train/run_training.py --script %s --config %s --save_dir %s --use_lmdb %d " \
        ...
        train_cmd = "python -m torch.distributed.launch --nproc_per_node %d --master_port %d /home/buaa/TransformerTrackers/BTTrack/lib/train/run_training.py " \
